...
public class HTRingMiddleJoint : MonoBehaviour
{
    //表示するオブジェクトを定義
    ...
    void Start()
    {
        handjoint = GameObject.Find("Ring2");
    }
    ...
    void Update()
    {
        ...
        //該当する関節の位置情報を取得
        if (HandJointUtils.TryGetJointPose(TrackedHandJoint.RingMiddleJoint, Handedness.Right, out MixedRealityPose pose))
        {
