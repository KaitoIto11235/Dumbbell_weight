...
public class HTMiddleDistalJoint : MonoBehaviour
{
    //表示するオブジェクトを定義
    ...
    void Start()
    {
        handjoint = GameObject.Find("Middle3");
    }
    ...
    void Update()
    {
        ...
        //該当する関節の位置情報を取得
        if (HandJointUtils.TryGetJointPose(TrackedHandJoint.MiddleDistalJoint, Handedness.Right, out MixedRealityPose pose))
        {
